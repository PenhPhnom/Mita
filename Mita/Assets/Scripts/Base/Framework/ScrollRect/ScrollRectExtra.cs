...
{
    [AddComponentMenu("UI/Scroll Rect Extra", 37)]
    [SelectionBase]
    [ExecuteAlways]
    ...
    /// </summary>
    /// <remarks>
    /// ScrollRectExtra will not do any clipping on its own. Combined with a Mask component, it can be turned into a scroll view.
    /// </remarks>
    public class ScrollRectExtra : UIBehaviour, IInitializePotentialDragHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement, ILayoutElement, ILayoutGroup
    {
        /// <summary>
        ...
        /// {
        ///     public ScrollRectExtra myScrollRect;
        ...
        ///         if (option == 0)
        ///         {
        ///             myScrollRect.movementType = ScrollRectExtra.MovementType.Clamped;
        ///         }
        ///         else if (option == 1)
        ///         {
        ///             myScrollRect.movementType = ScrollRectExtra.MovementType.Elastic;
        ///         }
        ///         else if (option == 2)
        ///         {
        ///             myScrollRect.movementType = ScrollRectExtra.MovementType.Unrestricted;
        ///         }
        ///     }
        /// }
        /// ]]>
        ...
        [Serializable]
        /// <summary>
        /// Event type used by the ScrollRectExtra.
        /// </summary>
        ...
        /// <summary>
        /// The content that can be scrolled. It should be a child of the GameObject with ScrollRectExtra on it.
        /// </summary>
        /// <example>
        /// <code>
        /// <![CDATA[
        ...
        ///     public void Start()
        ///     {
        ///         // assigns the contect that can be scrolled using the ScrollRectExtra.
        ...
        /// <summary>
        /// Optional Scrollbar object linked to the horizontal scrolling of the ScrollRectExtra.
        /// </summary>
        /// <example>
        /// <code>
        /// <![CDATA[
        ...
        ///     public void Start()
        ///     {
        ///         // Assigns a scroll bar element to the ScrollRectExtra, allowing you to scroll in the horizontal axis.
        ...
        /// <summary>
        /// Optional Scrollbar object linked to the vertical scrolling of the ScrollRectExtra.
        /// </summary>
        /// <example>
        /// <code>
        /// <![CDATA[
        ...
        ///     public void Start()
        ///     {
        ///         // Assigns a scroll bar element to the ScrollRectExtra, allowing you to scroll in the vertical axis.
        ...
        /// </summary>
        /// <remarks>
        /// onValueChanged is used to watch for changes in the ScrollRectExtra object.
        ...
        /// The UnityEvent.AddListener API for UI.ScrollRectExtra._onValueChanged takes a Vector2.
        ///
        ...
        /// shows how this can be done.The script is attached to the ScrollRectExtra object.
        /// </remarks>
        /// <example>
        /// <code>
        /// <![CDATA[
        ...
        /// {
        ///     static ScrollRectExtra scrollRect;
        ///
        ///     void Start()
        ///     {
        ///         scrollRect = GetComponent<ScrollRectExtra>();
...
#pragma warning restore 649
        ...
        ///     public void Start()
        ///     {
        ///         //Checks if the ScrollRectExtra called "myScrollRect" is active.
        ...
        public virtual void OnScroll(PointerEventData data)
        {
            ...
            Vector2 delta = ConstrainDrag(data.scrollDelta);
        ...
        public bool OnlyEnableDragWhenNeed;

        protected virtual Vector2 ConstrainDragIfNeeded(Vector2 delta)
        {
            if (!OnlyEnableDragWhenNeed)
                return delta;

            if (m_Content.sizeDelta.x <= viewRect.rect.width)
            {
                delta.x = 0;
            }

            if (m_Content.sizeDelta.y <= viewRect.rect.height)
            {
                delta.y = 0;
            }
            return delta;
        ...
        protected virtual Vector2 ConstrainDragIfEnableDrag(Vector2 delta)
        {
            if (DragEnabled)
                return delta;
            else
        ...
        protected Vector2 ConstrainDrag(Vector2 delta)
        {
            return ConstrainDragIfNeeded(ConstrainDragIfEnableDrag(delta));
        }
        ...
        public virtual void OnDrag(PointerEventData eventData)
        {
            ...
            pointerDelta = ConstrainDrag(pointerDelta);
        ...
        protected virtual void LateUpdate()
        {
            ...
            if (m_ViewBounds != m_PrevViewBounds || m_ContentBounds != m_PrevContentBounds || m_Content.anchoredPosition != m_PrevPosition)
            {
                ...
                UISystemProfilerApi.AddMarker("ScrollRectExtra.value", this);
        ...
        /// <summary>
        /// Helper function to update the previous data fields on a ScrollRectExtra. Call this before you change data in the ScrollRectExtra.
        /// </summary>
        ...
        /// <summary>
        /// Calculate the bounds the ScrollRectExtra should be using.
        /// </summary>
