...
namespace SuperScrollView
{
    ...
    */
    ...
    public class LoopStaggeredGridView : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
    {
        ...
        System.Action<LoopStaggeredGridViewItem, BaseUIItem, int> m_OnBaseUIItem;
        System.Func<LoopStaggeredGridView, int, int> m_PrefabsItem;
        ...
        */
        ...
        public void InitListView(int itemTotalCount, GridViewLayoutParam layoutParam,
            Action<LoopStaggeredGridViewItem, BaseUIItem, int> onBaseUIItem, System.Func<LoopStaggeredGridView, int, int> prefabsItem = null, StaggeredGridViewInitParam initParam = null)
        {
            mLayoutParam = layoutParam;
            if (mLayoutParam == null)
            {
        ...
        /// <returns></returns>
        public LoopStaggeredGridViewItem NewListViewItem(int index = 0)
        {
      ...
      */
        ...
        */
        ...
        private LoopStaggeredGridViewItem GetOnBaseUIItem(int index)
        {
            LoopStaggeredGridViewItem newItem;
