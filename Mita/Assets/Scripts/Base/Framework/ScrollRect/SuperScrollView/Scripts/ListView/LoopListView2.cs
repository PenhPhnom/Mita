...
namespace SuperScrollView
{
    ...
    public class LoopListView2 : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
    {
        ...
        System.Action<LoopListViewItem2, BaseUIItem, int> m_OnBaseUIItem;
        System.Func<LoopListView2, int, int> m_PrefabsItem;
        ...
        */
        ...
        public void InitListView(int itemTotalCount, Action<LoopListViewItem2, BaseUIItem, int> onBaseUIItem, System.Func<LoopListView2, int, int> prefansItem = null, LoopListViewInitParam initParam = null)
        {
            if (initParam != null)
            {
                mDistanceForRecycle0 = initParam.mDistanceForRecycle0;
            ...
            AdjustContainerPivot(mContainerTrans);
            InitItemPool();
            m_OnBaseUIItem = onBaseUIItem;
            m_PrefabsItem = prefansItem;
            if (mListViewInited == true)
            {
                Debug.LogError("LoopListView2.InitListView method can be called only once.");
            }
        ...
        */
        ...
        /// <returns></returns>
        public LoopListViewItem2 NewListViewItem(int index = 0)
        {
        ...
        */
        ...
        LoopListViewItem2 GetNewItemByIndex(int index)
        {
            ...
            LoopListViewItem2 newItem = GetOnBaseUIItem(index);
        ...
        private LoopListViewItem2 GetOnBaseUIItem(int index)
        {
            LoopListViewItem2 newItem;
            if (m_OnBaseUIItem != null)
            {
                int parfabIndex = (m_PrefabsItem != null) ? m_PrefabsItem(this, index) : 0;
                ...
                m_OnBaseUIItem?.Invoke(newItem, pBaseItem, index);
            }
            else
            {
