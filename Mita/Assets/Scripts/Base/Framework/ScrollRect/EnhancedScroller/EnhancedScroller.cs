...
namespace EnhancedUI.EnhancedScroller
{
    ...
    /// <summary>
    /// This delegate handles the scrolling callback of the ScrollRectExtra.
    /// </summary>
    ...
    public class EnhancedScroller : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
    {
        ...
        /// large inertial velocity that Unity adds in the ScrollRectExtra when dragging
        ...
        /// picks up the change in the ScrollRectExtra's position.
        ...
        /// <param name="cellPrefab">The prefab to use to create the cell view</param>
        /// <returns></returns>
        public EnhancedScrollerCellView GetCellView(int index = 0)
        {
            // see if there is a view to recycle
            var cellView = _GetRecycledCellView(m_EnhancedScrollerCellViewArray[index]);
            if (cellView == null)
            {
                // no recyleable cell found, so we create a new view
                // and attach it to our container
                var go = Instantiate(m_EnhancedScrollerCellViewArray[index].gameObject);
                cellView = go.GetComponent<EnhancedScrollerCellView>();
                cellView.transform.SetParent(_container);
                cellView.transform.localPosition = Vector3.zero;
                cellView.transform.localRotation = Quaternion.identity;
        ...
        [SerializeField]
        [DrawWithUnity]
        public EnhancedScrollerCellView[] m_EnhancedScrollerCellViewArray;
        ...
        /// </summary>
        private ScrollRectExtra _scrollRect;
        ...
        /// <summary>
        /// The number of fingers that are dragging the ScrollRectExtra.
        ...
        void Awake()
        {
            ...
            _scrollRect = this.GetComponent<ScrollRectExtra>();
        ...
        /// <summary>
        /// This event is fired while the user is dragging the ScrollRectExtra.
