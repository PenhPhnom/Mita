...
public partial class SanXiaoCanvasData
{
    ...
    public RectTransform TransThings;	
    public RectTransform TransThingsCount;	
    public RectTransform TransSweetType;	
    public Button BtnExitSweetType;	
    public RectTransform TransSweetTypeSelect;	
    ...
    public void InitUI(GameObject obj)
    {
        ...
        ImgStar1 = m_Injection.UIObjects[14].Component.GetComponent<Image>();		
        ImgStar2 = m_Injection.UIObjects[15].Component.GetComponent<Image>();		
        ImgStar3 = m_Injection.UIObjects[16].Component.GetComponent<Image>();		
        TransThings = m_Injection.UIObjects[17].Component.GetComponent<RectTransform>();		
        TransThingsCount = m_Injection.UIObjects[18].Component.GetComponent<RectTransform>();		
        TransSweetType = m_Injection.UIObjects[19].Component.GetComponent<RectTransform>();		
        BtnExitSweetType = m_Injection.UIObjects[20].Component.GetComponent<Button>();		
        TransSweetTypeSelect = m_Injection.UIObjects[21].Component.GetComponent<RectTransform>();		
